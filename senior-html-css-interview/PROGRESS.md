...
| Day | 예정 주제 | 핵심 개념 |
|-----|-----------|-----------|
| 2 | Document 구조와 Semantic HTML 심화 | `header`/`nav`/`main`/`article`/`section`/`aside`/`footer` 구분, `div` 남용의 실무 비용 |
...
**Day 1 완료** — 다음: Day 2 — Document 구조와 Semantic HTML 심화
...
- [ ] `header`/`nav`/`main`/`article`/`section`/`aside`/`footer` 구분 기준 (예정 Day 2)
