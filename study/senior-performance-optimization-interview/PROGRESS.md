...
| Day | 예정 주제 | 핵심 개념 |
|-----|-----------|-----------|
| 2 | DB 쿼리 튜닝 — EXPLAIN 읽기와 N+1 문제 | EXPLAIN ANALYZE, seq scan vs index scan, N+1, eager loading |
...
**Day 1 완료** — 다음: Day 2 — DB 쿼리 튜닝 (EXPLAIN 읽기와 N+1 문제)
...
- [ ] EXPLAIN ANALYZE 읽기 (예정 Day 2)
- [ ] N+1 문제 패턴 (예정 Day 2)
- [ ] B-Tree 인덱스 구조와 selectivity (예정 Day 3)
- [ ] 캐시 무효화 전략 (예정 Day 5)
