...
| Day | 예정 주제 | 핵심 개념 |
|-----|-----------|-----------|
| 2 | 타입 힌트 실전 | `typing`, `TypeVar`, `Protocol`, `TypedDict`, mypy |
...
- [ ] `typing` 모듈 — `Optional`, `Union`, `TypeVar`, `Generic` (예정 Day 2)
- [ ] `Protocol`로 구조적 서브타이핑 (예정 Day 2)
