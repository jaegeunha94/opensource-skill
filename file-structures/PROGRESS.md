...
**Day 7 완료** — 외부 정렬 (run generation, k-way merge, I/O pass 비용 계산).
**다음: Day 8** — 파일 시스템 구조 (inode vs FAT).

## Interview 답변 체크리스트

- [x] 어려운 개념을 전제 개념부터 쉬운 한국어로 설명한다. *(Day 1~7 완료)*
- [x] 왜 면접에서 이 질문을 묻는지 설명한다. *(Day 1~7 완료)*
- [x] 실제 운영 상황과 연결한다. *(Day 1~7 완료)*
- [x] 답변 순서를 단계적으로 제시한다. *(Day 1~7 완료)*
- [x] trade-off를 최소 2개 이상 비교한다. *(Day 1~7 완료)*
- [x] 흔한 오해와 약한 답변을 구분한다. *(Day 1~7 완료)*
- [x] follow-up 질문까지 대비한다. *(Day 1~7 완료)*
