...
| 7 | 2026-06-27 | 고급 인덱싱 | [0007-advanced-indexing.html](lessons/0007-advanced-indexing.html) |
| 8 | 2026-06-28 | 파일 시스템 | [0008-file-systems.html](lessons/0008-file-systems.html) |
| 9 | 2026-06-29 | 외부 정렬 | [0009-external-sorting.html](lessons/0009-external-sorting.html) |
...
**Day 9 완료** — Day 10 (종합 정리)을 시작할 준비가 됨.
...
- [x] 고급 인덱싱 — 복합 인덱스, 선두 컬럼 규칙, 비트맵 인덱스, 선택도, 커버링 인덱스 (Day 7)
- [x] 파일 시스템 — 연속/연결/인덱스 할당, FAT 구조, inode 다중 간접 포인터, 디렉터리 구조 (Day 8)
- [x] 외부 정렬 — k-way 합병, 교체 선택(런 길이 2M), 폴리페이즈 합병, 패스 수 계산 (Day 9)
- [ ] 파일구조 선택 기준 및 트레이드오프 비교 (예정 Day 10)
