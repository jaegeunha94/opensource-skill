...
| Day | 예정 주제 | 핵심 개념 |
|-----|-----------|-----------|
| 2 | 데이터베이스 설계 & 트랜잭션 | ACID, 격리 수준, 락, 인덱싱, 쿼리 최적화, 정규화 trade-off |
| 3 | 확장성 패턴 | 수평 확장, 샤딩, 레플리케이션, 캐싱 전략, CDN |
...
**Day 1 완료** — Day 2 (데이터베이스 설계 & 트랜잭션)가 다음 차례.
...
- [ ] 트랜잭션 격리 수준과 실무 적용 (예정 Day 2)
- [ ] 인덱싱 전략과 쿼리 최적화 (예정 Day 2)
- [ ] 수평 확장 패턴 (예정 Day 3)
