...
| Day | 예정 주제 | 핵심 개념 |
|-----|-----------|-----------|
| 2 | Reconciliation과 Virtual DOM | key, diffing 알고리즘, 리스트 렌더링 시 재사용/재생성 판단 |
...
**Day 1 완료** — 다음: Day 2 — Reconciliation과 Virtual DOM
...
- [ ] key 기반 reconciliation과 배열 인덱스를 key로 쓰면 안 되는 이유 (예정 Day 2)
