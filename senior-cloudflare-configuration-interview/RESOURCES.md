...
이 목록은 2026-07-04 기준으로 공식 문서/changelog/커뮤니티 공지를 확인해 작성했다(Day 2 작성 시 2026-07-05 기준으로 DNS/DNSSEC 관련 문서를, Day 3 작성 시 2026-07-06 기준으로 Cache Rules/Tiered Cache/캐시 스탬피드 관련 문서를 재확인해 링크를 추가함).
