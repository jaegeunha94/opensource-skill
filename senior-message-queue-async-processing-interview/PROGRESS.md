...
| Day | 예정 주제 | 핵심 개념 |
|-----|-----------|-----------|
| 2 | Kafka 아키텍처와 파티셔닝 / 순서 보장 설계 | Topic, Partition, Offset, Consumer Group, 순서 보장 조건, 파티션 키 설계 |
...
**Day 1 완료** — Day 2: Kafka 아키텍처와 파티셔닝 / 순서 보장 설계 예정.
