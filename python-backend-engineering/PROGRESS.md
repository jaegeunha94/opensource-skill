...
| Day | 예정 주제 | 핵심 개념 |
|-----|-----------|-----------|
| 2 | API 설계 원칙 — REST, OpenAPI, FastAPI 실전 | HTTP 메서드 의미론, 상태 코드, Path/Query/Body 파라미터, Pydantic 스키마, OpenAPI 자동 생성 |
...
**Day 1 완료** — Day 2 (API 설계 원칙)로 진행 예정.
...
- [ ] REST API 설계 원칙 (예정 Day 2)
- [ ] Pydantic v2 스키마 설계 (예정 Day 2)
